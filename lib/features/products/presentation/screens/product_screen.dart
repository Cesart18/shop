...
class ProductScreen extends ConsumerWidget {
  ...
  void showDialogo(BuildContext context) {
    ScaffoldMessenger.of(context).clearSnackBars();
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text('Producto Acualizado')));
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: productState.isLoading || productState.product == null
...
class _GenderSelector extends StatelessWidget {
  ...
  final void Function(String selectedGenres) onSizedChanged;
  const _GenderSelector(
      {required this.selectedGender, required this.onSizedChanged});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SegmentedButton(
        ...
        onSelectionChanged: (newSelection) {
          FocusScope.of(context).unfocus();
          onSizedChanged(newSelection.first);
        },
      ),
    );
  }
